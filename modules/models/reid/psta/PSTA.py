...
from .utils import weights_init_kaiming, init_pretrained_weight, weight_init_classifier
...
class PSTA(nn.Module):
    ...
    def __init__(self, num_classes, model_name, pretrain_choice, seq_len=8, **kwargs):
